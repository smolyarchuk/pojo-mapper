...
public class PojoMapperTest {
	...
	public void copyMappedPropertiesMixedWithAlternateMapping() {
		...
		Dto dto = PojoMapper.copyTo(new Dto()).from(domain).mapper(mapper).mapper("notMatchedProp4", "notMatchedProp2")
				.mapper("nestedProp.prop1", "notMatchedProp5").mapper("notMatchedProp3", "notMatchedProp1")
				.mapper("notMatchedProp2", "notMatchedProp4").mapper("notMatchedProp5", "nestedProp.prop1").copy();
	...
	public void copyForceRewrite() {
		...
		Dto dto = PojoMapper.copyTo(to).from(domain).mapper(mapper)
				/* .rewrite(true) */.copy();
